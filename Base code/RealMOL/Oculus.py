...
def main():
    ...
    commandTree = CommandNode(Types.Root, "", "")
    commandTree.create_tree(XMLFILE)
    debug = False
    ...
    while running:
        ...
        if not debug:
            ...
            pymol.cmd.move('x',(currp[1]-prevp[1])*ovr_sensitivity)
            pymol.cmd.move('y',-(currp[0]-prevp[0])*ovr_sensitivity)
        ...
        try:
            ...
            running, backupView = process_command(data, mollist, commandTree, backupView)
